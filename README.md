...
│── diagrams/               # ETL diagrams and flowcharts
│── data/                   # Example dataset (if small)
...
- **AWS S3** → Data lake storage (raw + processed data)
- **AWS Glue / PySpark** → Data cleaning & transformation
- **AWS Athena** → SQL queries on transformed data
- **Parquet Format** → Optimized storage format for analytics
...
- ✅ Automate ETL with **AWS Glue Jobs + Triggers**
- ✅ Add **Airflow orchestration** for scheduling
- ✅ Integrate **QuickSight / Power BI** dashboards
- ✅ Implement **real-time streaming pipeline** with **Kinesis + Spark Structured Streaming**
